            ...
            success: function (data) {
                ...
                if (features && features.length >= 1 && features[0]) {
                    ...
                    var codfoto = values.codigo_ant.substring(0, 17);
                            ...
                            select[9] = "<b>Uso Permitido</b>";
                            select[10] = "<b>Uso Actual</b>";    
                            select[11] = "<b>Unidades Acueducto</b>";
                            select[12] = "<b>Unidades Alcantarillado</b>";
                            select[13] = "<b>Unidades Aseo</b>";
                            select[14] = "<b>Tipo de Propiedad Prestadores</b>";   
                            ...
                            sel[7] = estaseo;
                            sel[8] = values.destino_hacienda;          
                            sel[9] = values.norma_uso;
                            sel[10] = values.uso_actual_zhf;
                            sel[11] = values.unid_acu;
                            sel[12] = values.unid_alc;
                            sel[13] = values.unid_aseo;
                            sel[14] = values.tipo_prop_prest;     
